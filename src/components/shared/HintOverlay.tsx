    ...
    <div className="fixed inset-0 z-[9999] pointer-events-none">
      ...
      {isMobile ? (
        ...
        <div className="fixed inset-0 pointer-events-none flex items-center justify-center">
          <div
            className={`
              pointer-events-auto rounded-lg shadow-2xl border
              max-w-sm min-w-80
              ${theme === 'gradient' || theme === 'dark'
            ...
            <div className={`flex items-center justify-between p-4 border-t ${
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={nextStep}
                    className="flex items-center px-3 py-1.5 text-sm font-medium rounded-lg transition-colors bg-blue-600 text-white hover:bg-blue-700"
                  >
                    {currentStep === steps.length - 1 ? (
                      'Finish'
                    ) : (
