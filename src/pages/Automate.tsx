...
import { Bot, Search, Package, BookOpen, Target, Zap } from 'lucide-react';
...
const Automate: React.FC = () => {
  ...
  const sections = [
    {
      title: "N8n AI Agents Room",
      description: "Deploy no-code GPT workflows for automated income streams and business processes",
    ...
    },
    {
      ...
      description: "Master ethical hacking, OSINT, and secure application development",
    ...
    },
    {
      ...
      description: "Novel AI for startup ideas and auto-generated plans & MVPs",
      icon: <Package className="h-6 w-6" />,
      to: "/genesis-engine",
      gradient: "from-green-500 to-teal-600",
      features: [
        "AI idea generation",
        "MVP blueprint creator",
    ...
    <div className="py-6 space-y-6">
      <div>
        <h1 className={`text-2xl font-bold flex items-center ${
          ...
          <Bot className="mr-2 h-7 w-7 text-purple-600 dark:text-purple-400" />
          Automate
        </h1>
        <p className={`mt-1 ${
          theme === 'gradient' ? 'text-gray-300' : 'text-gray-600 dark:text-gray-300'
        }`}>
          Deploy AI agents and automated workflows
        </p>
      </div>
